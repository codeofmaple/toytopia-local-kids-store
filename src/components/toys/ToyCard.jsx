...
const ToyCard = ({ toy }) => {
    ...
    return (
        <div className=" rounded-2xl shadow-md hover:shadow-xl transition-transform
         hover:-translate-y-0.5 border border-pink-100 p-4 flex flex-col
         bg-linear-to-b from-blue-100 to-pink-100 ">
            <div className="flex-1">
                {/* img */}
                <div className="relative w-full overflow-hidden h-44 md:h-60">
                    <img
                        src={pictureURL}
                        alt={toyName}
            ...
            <Link
                ...
                className="block text-center mt-3 bg-pink-600  text-white py-2.5 rounded-xl text-sm  hover:bg-pink-500 transition-all duration-200 active:scale-95 font-bold "
            >
                View More
            </Link>
        </div>
